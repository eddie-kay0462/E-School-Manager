...
<head>
    ...
    <title>Parent Login - Josephus Memorial School</title>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow">
                    <div class="card-body p-4">
                        <h2 class="text-center mb-4 text-primary">Parent Login</h2>
                        <form id="parentLogin" action="../actions/login_parent_backend.php" method="post">
                            <div class="mb-3">
                            ...
                            <div class="text-center mt-3">
                                <a href="parent-registration.php" class="text-decoration-none text-primary">Don't have an account? Register here</a>
                            </div>
                        </form>
                    </div>
                </div>
